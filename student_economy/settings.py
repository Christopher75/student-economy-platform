...
# ── Media files ──────────────────────────────────────────────────────────────
# Note: Render's disk is ephemeral. Media uploads persist only during
# the current deployment. For permanent storage upgrade to a paid Render
# Disk or use an external service like Cloudinary.
MEDIA_URL = '/media/'
